"""
MediChain AI - Patient Intake Agent (Cloud Deployment - PATCHED v4)
Simplified message handling using direct agent handlers (no protocol).
...
# ============================================================================
# MESSAGE HANDLER - Direct agent handler (no protocol)
# ============================================================================
...
async def handle_intake_message(ctx: Context, sender: str, msg: IntakeTextMessage):
    ...
    """
    ctx.logger.info(f"✅ [PATCH v4] Received intake message from {sender}")
...
async def startup(ctx: Context):
    ...
    ctx.logger.info("=" * 60)
    ctx.logger.info("MediChain AI - Patient Intake Agent (PATCH v4)")
    ctx.logger.info("=" * 60)
    ctx.logger.info(f"Agent address: {agent.address}")
    ctx.logger.info(f"Message handling: Direct agent handlers (no protocol)")
