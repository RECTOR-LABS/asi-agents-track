"""
MediChain AI - Patient Intake Agent (Cloud Deployment - PATCHED v2)
...
# ============================================================================
# MESSAGE MODELS - With Explicit Schema Registration
# ============================================================================
...
# Simplified message for receiving text from coordinator
...
# Create inter-agent protocol with explicit schema registration
inter_agent_proto = Protocol(name="PatientIntakeProtocol")


# ============================================================================
# MESSAGE HANDLERS - Using @protocol.on_message decorator
# ============================================================================
...
async def startup(ctx: Context):
    ...
    ctx.logger.info("=" * 60)
    ctx.logger.info("MediChain AI - Patient Intake Agent (Cloud - PATCHED v2)")
    ctx.logger.info("=" * 60)
